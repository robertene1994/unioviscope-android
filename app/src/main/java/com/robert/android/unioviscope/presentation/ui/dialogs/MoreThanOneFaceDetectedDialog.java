...
/**
 * Clase que crea un dialog con información relacionada con el hecho de se ha detectado más de un rostro en la foto
 * capturada por el estudiante.
 *
 * @author Robert Ene
 */
public class MoreThanOneFaceDetectedDialog {
    ...
    public static Dialog create(Context context, final CertifyAttendancePresenter presenter) {
        ...
        dialog.setMessage(LocaleUtil.getStringByLocale(context, R.string.msg_more_than_one_face_detected));
